...
<!--          </el-select>-->
          <el-tabs v-model="searchCheckOut.state" type="card" class="state-tabs" @tab-change="stateChenge" style="margin-bottom:0px;">
            <el-tab-pane label="全部" name="全部"></el-tab-pane>
            <el-tab-pane label="未审批" name="未审批"></el-tab-pane>
  ...
  <el-dialog title="退住申请审批" v-model="reDialogVisible" width="30%" class="dialog-content">
